...
/**
 * repositoryUrl/starCount는 프로젝트 생성 기능 구현 전이라 아직 아무도 채우지 않아 nullable입니다.
 * repositoryUrl은 생성 요청 body에 이미 들어오는 값을, starCount는 GitHub 레포지토리 조회 시점의
 * 스타 수 스냅샷을 그대로 저장하면 됩니다.
 */
