...
/**
 * 생성된 산문과 선택지를 코드와 대조해 의심 구간에 [QualityTag]를 붙입니다. LLM 콜을 쓰지 않습니다.
 *
 * 아무것도 버리지 않습니다. 붙는 태그는 "거짓이다"가 아니라 "의심스럽다"이고, 무엇을 감출지는
 * 서빙이 정합니다.
 */
@Component
class QualityInspector(
     ...
     * 산문에서 코드 식별자만 추려냅니다.
     *
     * 백틱 코드스팬을 먼저 봅니다. `Router`처럼 낙타 등이 하나뿐인 이름은 표기만으로 평범한 영어 단어와
     * 구분되지 않아, 생성 프롬프트가 백틱을 요구하고 여기서 그것을 믿습니다.
